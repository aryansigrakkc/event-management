...
const Home = () => {
    ...
    return (
        <>
           ...
           <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top" style={{ padding: "20px 0" }}>
            ...
            <div className="pt-5">
                {/* Add a padding top equal to the height of the fixed header to prevent content from being hidden underneath it */}
            </div>
            ...
            <div className="row justify-content-center mt-5">
                ...
                <div className="col-md-6 mt-5">
                    ...
                    <p> Wayne Morishita, Executive Director, Alberta Energy Efficiency Alliance</p>
                </div>
            </div>
